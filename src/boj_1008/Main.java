...
public class Main {
	...
	public static void main(String[] args) {
		...
		double result = ((double)a)/b; // a와 b의 나눗셈 결과를 result에 저장.
		// 주의할 점 : int 타입의 값을 서로 나눈 결과는 나머지가 버림되고 몫만 반환됨
		// 나머지가 버림되지 않고 실수형으로 출력되려면 적어도 어느 한 쪽을 실수형으로 형변환 해야한다.
