...
- 제목 : 수식 최대화
- 난이도 : Level 2
- 문제 : <a href="https://school.programmers.co.kr/learn/courses/30/lessons/67257" target="_blank">링크</a>
...
# 기존 표현식을 읽어가면서 숫자는 숫자형태로 삽입하고, 연산자는 문자열 값 그대로 삽입
# 연산자를 처음 만났다면 기존 v 를 삽입후 v 를 0 으로 초기화
